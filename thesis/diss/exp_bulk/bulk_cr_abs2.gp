...
plot crv(x,w1,t1)/crv(0,w1,t1) not w l 0, FILENAME every 2:::(f1)::(f1) u ($41*0.0401):((1/($11+$17+$19/1e9* $13/1e9)-o1)/A1/crv(0,w1,t1)) ti "U_{clamp}=80V" w p 1 4, \
     crv(x,w2,t2)/crv(0,w2,t2) not w l 0, FILENAME every 2:::(f2)::(f2) u ($41*0.0401):((1/($11+$17+$19/1e9* $13/1e9)-o2)/A2/crv(0,w2,t2)) ti "U_{clamp}=60V" w p 2 5, \
     crv(x,w3,t3)/crv(0,w3,t3) not w l 0, FILENAME every 2:::(f3)::(f3) u ($41*0.0401):((1/($11+$17+$19/1e9* $13/1e9)-o3)/A3/crv(0,w3,t3)) ti "U_{clamp}=40V" w p 3 6, \
     crv(x,w4,t4)/crv(0,w4,t4) not w l 0, FILENAME every 2:::(f4)::(f4) u ($41*0.0401):((1/($11+$17+$19/1e9* $13/1e9)-o4)/A4/crv(0,w4,t4)) ti "U_{clamp}=20V" w p 4 7
