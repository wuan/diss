...
plot FILENAME every :::2::2 u ($1/384*2.2):(w($2)/1e9/2/pi) ti "U_{crit}=384V" w lp ls 1 ps 7, \
     FILENAME every :::1::1 u ($1/81*1.4):(w($2)/1e9/2/pi) ti "U_{crit}=81V" w lp ls 3 ps 9
