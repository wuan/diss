...
plot "<bzcat ../data/cr0202d4.dat.bz2" u (d0($1,26)*1e9):(1/$5/2/pi/1e9) ti "SiO_2" w lp 1 7, \
	"<bzcat ../data/crpaper2_fit.dat.bz2" u (d0(h($1)*1e-3,20)*1e9):(1/$5/2/pi/1e9) ti "PMMA" w lp 3 6
