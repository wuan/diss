...
plot FILENAME every (n):::(i)::(i) u (n*$0):(($11+$17+$19/1e9*$13/1e9)/t) not w p 6, f2(x) not w l ls 1
...
plot FILENAME every :::(i):20:(i) u 0:(($11+$17+$19/1e9*$13/1e9)/t) not w p 6, \
	FILENAME every (n):::(i)::(i) u (n*$0):(($11+$17+$19/1e9*$13/1e9)/t) not w p 6, f2(x) not w l ls 1
...
plot FILENAME every :::(i):5:(i) u ($0-1):(($11+$17+$19/1e9*$13/1e9)/t) not w p 6, \
	FILENAME every (n):::(i)::(i) u (n*$0-1):(($11+$17+$19/1e9*$13/1e9)/t) not w p 6, f2(x) not w l ls 1
...
plot FILENAME every :::(i):10:(i) u 0:(($11+$17+$19/1e9*$13/1e9)/t) not w p 6, \
	FILENAME every (n):::(i)::(i) u (n*$0):(($11+$17+$19/1e9*$13/1e9)/t) not w p 6, f2(x) not w l ls 1
...
plot FILENAME every :::(i):4:(i) u 0:(($11+$17+$19/1e9*$13/1e9)/t) not w p 6, \
	FILENAME every (n):::(i)::(i) u (n*$0):(($11+$17+$19/1e9*$13/1e9)/t) not w p 6, f2(x) not w l ls 1
set nomultiplot
