...
set parametric
plot "<bzcat ../data/mw0204d3.dat.bz2 | smooth -n 5 -" every 2::10:(i):490:(i) u (n10(h,$10-V1,ds,eps,dC3)):(log($11+$17+$19/1e9*$13/1e9)/log(10)*20) axes x2y1 ti "Transmission" w p 7, \
