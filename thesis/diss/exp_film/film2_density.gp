...
set parametric
plot "<bzcat ../../data/microwave/2002/mw0204d3/mw0204d3.dat.bz2 | smooth -n 5 -" every 2::10:(i):490:(i) u (n10(h,$10-V1,ds,eps,dC3)):(log($11+$17+$19/1e9*$13/1e9)/log(10)*20) axes x2y1 ti "Transmission" w p 7, \
	"" every 2::10:(i):490:(i) u (n10(h,$10-V1,ds,eps,dC3)):($13/1e9) axes x2y2 ti "Resonanzfrequenz" w p 4, \
	n10(h,dV,ds,eps,dC3),-16.2+t/3 axes x2y1 not w l 3
