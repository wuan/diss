...
plot FILENAME every 3::280:20:570:20  u 10:(log($11+$17+$19/1e9*$13/1e9)/log(10)*20) ti "Transmission" w p pt 7, \
	 FILENAME every 3::280:20:570:20  u 10:($13/1e9) axes x1y2 ti "Frequenz" w p pt 4
