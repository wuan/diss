...
set parametric
plot "<bzcat ../data/mw0109d5.dat.bz2 |smooth -n 5 -" every 6:::(i):1050:(i) u (n10(h,$10-V1,ds,eps,dC3)):(log($11+$17+$19/1e9*$13/1e9)/log(10)*20) axes x2y1 ti "Transmission" w p ps 7, \
	 "" every 6:::(i)::(i) u (n10(h,$10-V1,ds,eps,dC3)):($13/1e9) axes x2y2 ti "Resonanzfrequenz" w p ps 4, \
