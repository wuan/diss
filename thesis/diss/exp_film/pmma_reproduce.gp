...
plot FILENAME every 5:::(i):550:(i) u 10:(log($11+$17+$19/1e9*$13/1e9)/log(10)*20) ti "frühe Beladung" w p 7, \
	FILENAME every :::(i):180:(i) u 10:(log($11+$17+$19/1e9*$13/1e9)/log(10)*20) not w p 7, \
	f1(x) not, \
	FILENAME every 5:::(j):400:(j) u 10:(log($11+$17+$19/1e9*$13/1e9)/log(10)*20) ti "später" w p 6, \
	FILENAME every :::(j):180:(j) u 10:(log($11+$17+$19/1e9*$13/1e9)/log(10)*20) not w p 6, \
	f2(x) not
