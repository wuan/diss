...
set key at screen 0.555,0.92 samplen 0.5 spacing 1.5
set ytics nomirror
set yr [-17.5:-16]
set xtics 3600
set y2tics 0.0001
...
set parametric
plot FILENAME every 8:::6::8 u 1:(log($11+$17+$19/1e9*$13/1e9)/log(10)*20) ti "Transmission" w p pt 7, \
	FILENAME every 8:::6::8 u 1:($13/1e9) axes x1y2 ti "Frequenz" w p pt 4, \
