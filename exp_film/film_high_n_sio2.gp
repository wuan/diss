...
set key left width 20 samplen 0.5 spacing 1.5

plot FILENAME every 9:::(i)::(i) u (n10(l,$10-V1,ds,eps,dC3)):(log($11+$17+$19/1e9*$13/1e9)/log(10)*20) axes x2y1 ti "Transmission" w p pt 7, \
	FILENAME every 9:::(i)::(i) u (n10(l,$10-V1,ds,eps,dC3)):($13/1e9) axes x2y2 ti "Frequenz" w p pt 4
